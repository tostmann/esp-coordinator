...
namespace utils {
	...
	const char* get_nlme_status_str(uint8_t status) {
	    switch(status) {
	        case ZB_NWK_COMMAND_STATUS_NO_ROUTE_AVAILABLE          : return "No route available"; break;
	        case ZB_NWK_COMMAND_STATUS_TREE_LINK_FAILURE           : return "Tree link failure"; break;
	        case ZB_NWK_COMMAND_STATUS_NONE_TREE_LINK_FAILURE      : return " one-tree link failure"; break;
	        case ZB_NWK_COMMAND_STATUS_LOW_BATTERY_LEVEL           : return "Low battery level"; break;
	        case ZB_NWK_COMMAND_STATUS_NO_ROUTING_CAPACITY         : return "No routing capacity"; break;
	        case ZB_NWK_COMMAND_STATUS_NO_INDIRECT_CAPACITY        : return "No indirect capacity"; break;
	        case ZB_NWK_COMMAND_STATUS_INDIRECT_TRANSACTION_EXPIRY : return "Indirect transaction expiry"; break;
	        case ZB_NWK_COMMAND_STATUS_TARGET_DEVICE_UNAVAILABLE   : return "Target device unavailable"; break;
	        case ZB_NWK_COMMAND_STATUS_TARGET_ADDRESS_UNALLOCATED  : return "Target address unallocated"; break;
	        case ZB_NWK_COMMAND_STATUS_PARENT_LINK_FAILURE         : return "Parent link failure"; break;
	        case ZB_NWK_COMMAND_STATUS_VALIDATE_ROUTE              : return "Validate route"; break;
	        case ZB_NWK_COMMAND_STATUS_SOURCE_ROUTE_FAILURE        : return "Source route failure"; break;
	        case ZB_NWK_COMMAND_STATUS_MANY_TO_ONE_ROUTE_FAILURE   : return "Many-to-one route failure"; break;
	        case ZB_NWK_COMMAND_STATUS_ADDRESS_CONFLICT            : return "Address conflict"; break;
	        case ZB_NWK_COMMAND_STATUS_VERIFY_ADDRESS              : return "Verify address"; break;
	        case ZB_NWK_COMMAND_STATUS_PAN_IDENTIFIER_UPDATE       : return "Pan ID update"; break;
	        case ZB_NWK_COMMAND_STATUS_NETWORK_ADDRESS_UPDATE      : return "Network address update"; break;
	        case ZB_NWK_COMMAND_STATUS_BAD_FRAME_COUNTER           : return "Bad frame counter "; break;
	        case ZB_NWK_COMMAND_STATUS_BAD_KEY_SEQUENCE_NUMBER     : return "Bad key sequence number"; break;
	        case ZB_NWK_COMMAND_STATUS_UNKNOWN_COMMAND             : return "Command received is not known "; break;
	    }
	    return "unknown";
	}
}